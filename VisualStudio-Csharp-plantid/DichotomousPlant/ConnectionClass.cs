...
namespace DichotomousPlant
{
    ...
    public static class ConnectionClass
    {
        ...
        private static string _globalConnString = "datasource=127.0.0.1;port=3306;username=root;password=yourseverpw;";
        ...
        {
            // Programicallly AUTO INCREMENT the species index
            int selectCount = getTableRowCount("SELECT COUNT(*) FROM plantdb.species;");
            ...
            string query = string.Format("INSERT INTO plantdb.species VALUES ('{0}', '{1}', '{2}', '{3}', '{4}')",
                    selectCount,
        ...
        public static int getTableRowCount(string querystring)
        {
            ...
            queryResult = int.Parse(command.ExecuteScalar().ToString());
