...
namespace DichotomousPlant
{
    ...
    {
        private static string _globalConnString = "datasource=127.0.0.1;port=3306;username=root;password=pw;";
        ...
        public static bool identicalSpecies(species input_species)
        {
            ...
            string querycountstring = "SELECT COUNT(*) FROM dbo.species WHERE ((speciesName = '" + input_species.speciesName + "') AND " + " (speciesSymbol = '" + input_species.speciesSymbol + "') AND " + "(speciesCommonName = '" + input_species.speciesCommonName + "') AND " + " (speciesDescription = '" + input_species.speciesDescription + "') AND " + "(genus_FK = '" + input_species.genus_FK + "'))";
            MySqlConnection conn = new MySqlConnection(DichotomousPlant.ConnectionClass.GlobalConnectionVarClass);
        ...
        public static species returnSpeciesrecord(int speciesID)
        {
            ...
            while (reader.Read())
            {
                ...
                speciesEntityrecord = new species(id, name, symbol, commonname, description, genusFK);
            }
